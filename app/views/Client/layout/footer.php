                    ...
                    <div class="container">
                        <div class="row mb--40 mb-md--30">
                            ...
                            <div class="col-lg-2 col-md-6 mb-md--30">
                                <div class="footer-widget">
                                    ...
                                    <ul class="widget-menu">
                                        ...
                                        <li><a href="#">Điều Khoản & Tình Trạng</a></li>
                            ...
                            <div class="col-lg-2 col-md-6 mb-sm--30">
                                <div class="footer-widget">
                                    <h3 class="widget-title">Bổ sung</h3>
                                    <ul class="widget-menu">
                                    ...
                                    <div class="widget-product">
                                        <div class="product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <h4 class="product-title">
                                                    <a href="" tabindex="0">Đồng Hồ RoLex Sang Trọng</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <h4 class="product-title">
                                                    <a href="" tabindex="0">Đồng Hồ Chạy Pin</a>
                                                </h4>
                                                <div class="product-price-wrapper">
                                                    <span class="money">$550.00</span>
                                                    <span class="product-price-old">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-md-6">
                                            <div class="modal-box product">
                                                <h3 class="product-title">Đồng Hồ Casino</h3>
                                                ...
                                                <ul class="product-detail-list list-unstyled mb--20">
                                                    <li>Thương Hiệu: <a href="#">Apple</a></li>
                                                    <li>Mã Sản Phẩm: Đồng Hồ</li>
                                                    <li>Điểm thưởng: 600</li>
                                                    <li>Khả Dụng: Trong Kho</li>
                                                </ul>
                                                ...
                                                <div class="product-options mb--20">
                                                    ...
                                                    <div class="form-group">
                                                        <label><sup>*</sup>Chọn màu sắc</label>
                                                        <select>
                ...
                <!-- Mirrored from htmldemo.net/mirora/mirora/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 15:56:57 GMT -->
