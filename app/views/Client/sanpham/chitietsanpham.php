                    ...
                    <div class="col-lg-6">
                        <div class="product-details-content">
                            <div class="product-details-top">
                                ...
                                <div class="ratings-wrap">
                                    <div class="ratings">
                                        <p>Chỉ còn: <?= $load_one_sp['gia_giam']  ?></p>
                                ...
                                <div class="ratings-wrap">
                                    <div class="ratings">
                                        <p>Màu sắc:
                                            <?php if ($load_one_sp['mau_sac'] == 0) {
                                                echo "Đen";
                                            } elseif ($load_one_sp['mau_sac'] == 1) {
                                                echo "Bạc";
                                            } elseif ($load_one_sp['mau_sac'] == 2) {
                                                echo "Xám";
                                            } elseif ($load_one_sp['mau_sac'] == 3)
                                                echo "Nâu";
                                            ?>
                                        </p>
                                ...
                                <div class="ratings-wrap">
                                    <div class="ratings">
                                        <p>kích thước: <?= $load_one_sp['kich_thuoc'] ?></p>
                                    </div>
                                </div>
                                <div class="ratings-wrap">
                                    <div class="ratings">
                                        <p>Chất liệu: <?= $load_one_sp['chat_lieu'] ?></p>
                                    </div>
                                </div>
                                <div class="ratings-wrap">
                                    <div class="ratings">
                                        <p>Bảo hành: <?= $load_one_sp['bao_hanh'] ?></p>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <ul class="product-details-tab-head nav nav-tab" id="singleProductTab" role="tablist">
                            <li class="nav-item product-details-tab-item">
                                <a class="nav-link product-details-tab-link active" id="nav-desc-tab" data-bs-toggle="tab" href="#nav-desc" role="tab" aria-controls="nav-desc" aria-selected="true">Mô tả</a>
                            </li>
                        </ul>
